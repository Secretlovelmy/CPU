...
typedef struct APEX_CPU
{
    ...
    int architectureRegisters[48];    //architecture register and the value it contains
    Register physicalRegisters[48];    //Physical register and the value it contains
    int allocationList[48];   //1- physical regs is allocated to someone and 0- if physical register is free
    int renameTable[48];   //index- arch register and value is the physical register
    int backendRAT[48];
