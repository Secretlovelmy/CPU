...
## Files:
 ...
 - `cpu.h` - Data structures declarations
 - `apex_cpu.c` - Implementation of APEX cpu
 - `methods.c` -  Used in the implementation
...
```
 Run as follows:
```
 ./apex_sim <input_file_name> <display/simulate> <clock cycle>
```

## Author

 - Copyright (C)  Yu Yang (yyang200@binghamton.edu)
 - Copyright (C)  Peilun Feng (pfeng1@binghamton.edu)
